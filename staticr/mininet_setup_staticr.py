...
class POX( Controller ):
    def __init__( self, name, cdir=POXDIR,
                  ...
                  cargs=( 'openflow.of_01 --port=%s '
                          'messenger messenger.tcp_transport price_static_requests' ),
                  **kwargs ):
...
#create three queues on each interface (eth1 -> eth4)
...
os.system('sudo ovs-vsctl -- set Port s1-eth2 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=1000000000 queues=3=@q0,4=@q1,5=@q2 -- --id=@q0 create Queue other-config:min-rate=500000000 other-config:max-rate=500000000 -- --id=@q1 create Queue other-config:min-rate=300000000 other-config:max-rate=300000000 -- --id=@q2 create Queue other-config:min-rate=200000000 other-config:max-rate=200000000')
os.system('sudo ovs-vsctl -- set Port s1-eth3 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=1000000000 queues=6=@q0,7=@q1,8=@q2 -- --id=@q0 create Queue other-config:min-rate=500000000 other-config:max-rate=500000000 -- --id=@q1 create Queue other-config:min-rate=300000000 other-config:max-rate=300000000 -- --id=@q2 create Queue other-config:min-rate=200000000 other-config:max-rate=200000000')
os.system('sudo ovs-vsctl -- set Port s1-eth4 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=1000000000 queues=9=@q0,10=@q1,11=@q2 -- --id=@q0 create Queue other-config:min-rate=500000000 other-config:max-rate=500000000 -- --id=@q1 create Queue other-config:min-rate=300000000 other-config:max-rate=300000000 -- --id=@q2 create Queue other-config:min-rate=200000000 other-config:max-rate=200000000')
