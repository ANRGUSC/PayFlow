...
class PriceStaticRequestsSwitch(object):
  ...
  def flood(self,priority,idle,hard,classifier,data=None):
    msg = of.ofp_flow_mod()
    msg.data = data
  ...
  def enqueue(self,priority,idle,hard,classifier,dstIP,port,queue,srcIP=None,data=None):
    msg = of.ofp_flow_mod()
    msg.data = data
    msg.priority = priority
    msg.idle_timeout = idle
  ...
  def output(self,priority,idle,hard,classifier,dstIP,port,data=None):
    msg = of.ofp_flow_mod()
    msg.data = data
    msg.priority = priority
    msg.idle_timeout = idle
